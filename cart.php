        ...
        <table class="table table-bordered text-center">
            ...
            <tbody>";
                ...
                <tr>
                    ...
                    <td><img src="./photos/buy-1.jpg" alt="" class="cart_img"></td>
                    ...
                    <td>
                        <!----<button class="bg-info p-3 py-2
                         border-0 text-light">Update</button>-->
            <input type="submit" value="Update Cart" class="bg-info p-3 py-2
                         border-0 text-light" name="update_cart">
                        <!----<button class="bg-info p-3 py-2
            border-0 text-light">Remove</button>--->
            <input type="submit" value="Remove Cart" class="bg-info p-3 py-2
                         border-0 text-light" name="remove_cart">
        ...
        <div class="d-flex mb-5">
          ...
          if($result_count>0){
            ...
            echo" <h4 class='px-3'>Subtotal:<strong class='text-info'>
             ...
             <input type='submit' value='Continue Shopping' class='bg-info p-3 py-2
             border-0 text-light' name='continue_shopping'>
            
          <button class='bg-secondary p-3 py-2
          border-0 '><a href='./users_area/checkout.php' class='text-light text-decoration-none'>
          Checkout</a></button>";

          }else{
            echo "<input type='submit' value='Continue Shopping' class='bg-info p-3 py-2
            border-0 text-light' name='continue_shopping'>";
